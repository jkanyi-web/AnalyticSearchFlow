...
- [📖 AnalyticSearchFlow ](#-AnalyticSearchFlow-)
...
# 📖 AnalyticSearchFlow <a name="about-project"></a>

This app is a Real-time search analytics platform providing insights into user search trends and behavior
...
```
git clone git@github.com:jkanyi-web/AnalyticSearchFlow.git
```
...
Feel free to check the [issues page](https://github.com/jkanyi-web/AnalyticSearchFlow/issues).
